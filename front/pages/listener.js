    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.songContainer}>
          ...
          <div>
            <ReactAudioPlayer id={styles.Player} src='http://localhost:3001/audio/1' controls />
          </div>
        </div>
        <div className={styles.userInfo}>
          <Image id={styles.UserImage} src='/assets/image1.jpg' width='60' height='60' />
        ...
        <div className={styles.userComments}>
          ...
          <div className={styles.commentSection}>
            {/* comment 1 */}
            <div>
              <Image id={styles.UserImage} src='/assets/VERBIN.png' width='60' height='60' />
